...
EZ3.Texture = function(generateMipmaps) {
  ...
  this.flipY = false;
  this.generateMipmaps = generateMipmaps || true;
  this.dirty = true;
};
...
EZ3.Texture.prototype.updateImage = function(gl, target, image) {
...
EZ3.Texture.prototype.updateMipmaps = function(gl) {
  if (!this.generateMipmaps) {
    this.wrapS = EZ3.Texture.CLAMP_TO_EDGE;
    this.wrapT = EZ3.Texture.CLAMP_TO_EDGE;
    this.magFilter = EZ3.Texture.LINEAR;
...
EZ3.Texture.prototype.updatePixelStore = function(gl) {
...
EZ3.Texture.prototype.updateParameters = function(gl, target) {
